...
<%--                        </div>--%>
<%--                    </c:if>--%>
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model"> <!--model se matching cac field trong name qua NewDTO -->
                        <div class="form-group">
                            <label for="categoryCode" class="col-sm-3 control-label no-padding-right">Thể loại:</label>
                            <div class="col-sm-9">
<%--                                <select class="form-control" id="categoryCode" name="categoryCode">--%>
<%--                                    <option value="">-- Chọn thể loại</option>--%>
<%--                                    <c:forEach var="item" items="categoryCode">--%>
<%--                                        <options value="${item.code}",value="${item.name}"/>--%>
<%--                                    </c:forEach>--%>
<%--                                </select>--%>
...
<%--                                <input type="text" class="col-xs-10 col-sm-5" id="title" name="title" value="${model.title}"/>--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <form:textarea path="shortDescription" rows="10" cols="20" cssClass="form-control" id="shortDescription"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content" class="col-sm-3 control-label no-padding-right">Nội dung:</label>
                            <div class="col-sm-9">
                                <form:textarea path="content" rows="40" cols="20" cssClass="form-control" id="content"/>
<%--                                <form:textarea path="content" rows="40" cols="20" cssStyle="width: 820px;height: 175px;" cssClass="form-control" id="content"/>--%>
                            </div>
                        </div>
...
<script>
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        // form data day ve api dang json
        var data = {};
        // fom data chi la js ben phia client
        var formData = $('#formSubmit').serializeArray(); //serializaArray get dc value vs id=formSubmit
