...
<%--                    <div class="form-group">--%>
<%--                        <label for="categoryCode" class="col-sm-3 control-label no-padding-right" for="form-field-1">Thể--%>
<%--                            loại : </label>--%>
<%--                        <div class="col-sm-9">--%>
...
<%--                        <label for="shortDescription" class="col-sm-3 control-label no-padding-right">Mô tả ngắn:</label>--%>
<%--                        <div class="col-sm-9">--%>
<%--                            <form:textarea path="shortDescription" rows="5" cols="10" cssClass="form-control"--%>
<%--                                           id="shortDescription"/>--%>
<%--                        </div>--%>
<%--                    </div>--%>
